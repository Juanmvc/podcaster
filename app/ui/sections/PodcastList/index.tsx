...
export default function PodcastList({
  ...
  return (
    <div className={classes[MODULE_PREFIX]}>
      <div data-testid="podcast-list-page-filter" className={classes[`${MODULE_PREFIX}__filter`]}>
      ...
      <div data-testid="podcast-list-page-grid" className={classes[`${MODULE_PREFIX}__grid`]}>
