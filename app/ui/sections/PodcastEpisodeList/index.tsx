...
import PodcastEpisode, { PodcastEpisodePrimitiveProps } from '@/app/domain/entities/PodcastEpisode';
...
export default function PodcastEpisodeList({
  ...
  const podcastEpisodesEntityList = data.map(podcast => PodcastEpisode.fromPrimitive({...podcast}))

  const podcastEpisodesTableRows = presentPodcastEpisodesTableRow({episodes: podcastEpisodesEntityList, podcastID: podcastID});
